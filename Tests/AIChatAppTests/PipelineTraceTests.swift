...
struct PipelineStageTests {
    ...
    /// The count that makes "all 43 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 43 ecosystem packages, each at least once")
    func coversEveryPackage() {
        ...
        let expected: Set<String> = [
            ...
            "ExplorationChannelKit", "LabelReturnKit"
        ]
