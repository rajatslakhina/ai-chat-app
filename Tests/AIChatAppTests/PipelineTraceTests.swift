...
struct PipelineStageTests {
    ...
    /// The count that makes "all 49 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 50 ecosystem packages, each at least once")
