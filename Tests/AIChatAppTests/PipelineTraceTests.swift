...
struct PipelineStageTests {
    ...
    /// The count that makes "all 39 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 39 ecosystem packages, each at least once")
