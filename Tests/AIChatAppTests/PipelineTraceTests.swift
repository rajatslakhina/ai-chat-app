...
struct PipelineStageTests {
    ...
    /// The count that makes "all 36 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 36 ecosystem packages, each at least once")
