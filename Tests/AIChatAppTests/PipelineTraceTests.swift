...
struct PipelineStageTests {
    ...
    /// The count that makes "all 54 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 54 ecosystem packages, each at least once")
