...
struct PipelineStageTests {
    ...
    /// The count that makes "all 55 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 57 ecosystem packages, each at least once")
