...
struct PipelineStageTests {
    ...
    /// The count that makes "all 45 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 45 ecosystem packages, each at least once")
