...
struct PipelineStageTests {
    ...
    /// The count that makes "all 37 packages are wired in" checkable rather than claimed.
    @Test("the stages cover all 37 ecosystem packages, each at least once")
    func coversEveryPackage() {
        ...
        let expected: Set<String> = [
            ...
            "SourceIndependenceKit", "TemporalValidityKit"
        ]
