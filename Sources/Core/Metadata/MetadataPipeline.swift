...
actor MetadataPipeline {
    ...
    func generate(
        ...
        await auditEffectiveComparison(trace: &trace)
        await auditObservedNull(trace: &trace)
        ...
        await auditUnconditionalExact(trace: &trace)
        ...
        await auditDelayCurve(trace: &trace)
        await auditCurveDivergence(trace: &trace)
        await auditLabelClock(trace: &trace)
